					 ...
					 char *cmd)
{
	...
	*value++ = '\0';
	...
	if (os_strcasecmp(cmd, "EAPOL::heldPeriod") == 0) {
		...
		wpa_s->wps_fragment_size = AtoiToStrtol(value);
		...
		int disabled = AtoiToStrtol(value);
